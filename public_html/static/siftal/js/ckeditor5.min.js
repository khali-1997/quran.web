...
function pushState()
{
	...
	{
		if($(_e.target).is('[data-editor]'))
		{
			if(_e.which === 113)
			{
				toggleEditor($(_e.target).data('editorObj'), $(_e.target));
				_e.preventDefault();
			}
		}
	})

	$('[data-editor-destroy]').on('click', function()
	{
		editor.destroy();
		var targetDestroy = $(this).attr('data-editor-destroy');
...
function toggleEditor(_editor, _this)
{
	if(_editor)
	{
		_editor.destroy();
