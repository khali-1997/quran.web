...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Name");                                                                  // Line 21
	echo T_("Mobile");                                                                // Line 152
	echo T_("Price");                                                                 // Line 33
	echo T_("Toman");                                                                 // Line 47
	echo T_("Request Advice");                                                        // Line 43
	echo T_("Thank You");                                                             // Line 9
	echo T_("Also you can share our project to everyone and we are say thank you.");  // Line 11
	echo T_("Have Question?");                                                        // Line 64
	echo T_("If you have any questions, please do not hesitate to <a href='contact'>contact us</a>.");// Line 65
	echo T_("In <a href='support'>help center</a> we are answer some frequent questions.");// Line 65
	echo T_("Doners");                                                                // Line 69
	echo T_("Thanks to the generous support of donors like you. see our doners");     // Line 70
	echo T_("Your ongoing support is helping share Quran via SalamQuran around the world in cyberspace.");// Line 70
	...
	echo T_("Country");                                                               // Line 59
	echo T_("Size");                                                                  // Line 67
	echo T_("Count file");                                                            // Line 68
	echo T_("Language");                                                              // Line 84
	echo T_("Narrator");                                                              // Line 85
	echo T_("Clear filters");                                                         // Line 121
	echo T_("Result not found!");                                                     // Line 120
	echo T_("Search with new keywords.");                                             // Line 120
	...
	echo T_("Download");                                                              // Line 104

	//----------------------------docs\Projects\SalamQuran\content\blog-2\display.html
	...
	//------------------------docs\Projects\SalamQuran\content\calculator\display.html
	...
	//----------------------docs\Projects\SalamQuran\content\home\homepage-donate.html
	...
	echo T_("by");                                                                    // Line 7
	echo T_("BECOME A SPONSOR");                                                      // Line 10

	//------------------docs\Projects\SalamQuran\content\home\homepage-quoteQuran.html
	echo T_("Sura");                                                                  // Line 93
	echo T_("Ayah");                                                                  // Line 14
	echo T_("Page of the day");                                                       // Line 67
	...
	echo T_("For share via social networks");                                         // Line 48
	echo T_("Short link");                                                            // Line 56
	echo T_("PDF");                                                                   // Line 104
	...
	echo T_("News Link");                                                             // Line 103
	echo T_("Most Popular");                                                          // Line 124
	echo T_("Latest News");                                                           // Line 138
	echo T_("Blog");                                                                  // Line 151
	...
	echo T_("Aye of the day");                                                        // Line 65
	echo T_("Random aye");                                                            // Line 66
	echo T_("Random Page");                                                           // Line 68
	echo T_("API");                                                                   // Line 72
	echo T_("Developers");                                                            // Line 73
	...
	echo T_("Enter to Panel");                                                        // Line 91
	echo T_("Enter");                                                                 // Line 44
	echo T_("Iran NSR Certification");                                                // Line 106
	echo T_("Iran NSR");                                                              // Line 106
	echo T_("Enamad Certification");                                                  // Line 108
	echo T_("Enamad");                                                                // Line 108
	echo T_("Samandehi Certification");                                               // Line 111
	echo T_("Samandehi");                                                             // Line 111
	echo T_("Shamad Certification");                                                  // Line 113
	echo T_("Shamad");                                                                // Line 113
	echo T_("Software Solution Designer");                                            // Line 124
	echo T_("Developed by Ermile");                                                   // Line 124
	...
	//----------------------------docs\Projects\SalamQuran\content\random\display.html
	echo T_("Random aya");                                                            // Line 8
	echo T_("Rndom page");                                                            // Line 11
	...
	echo T_("News Code");                                                             // Line 48
	echo T_("Recommended for you");                                                   // Line 66
	...
	//-----------------------------docs\Projects\SalamQuran\content\today\display.html
	...
	//------------------------docs\Projects\SalamQuran\content_a\fav\home\display.html
	echo T_("Favorites");                                                             // Line 52
	echo T_("Date and time");                                                         // Line 54
	echo T_("Action");                                                                // Line 81
	echo T_("Remove");                                                                // Line 99
	echo T_("Hi!");                                                                   // Line 127
	echo T_("No favorites added");                                                    // Line 112

	//------------------------------docs\Projects\SalamQuran\content_a\fav\layout.html
	echo T_("Manage");                                                                // Line 6

	//----------------------docs\Projects\SalamQuran\content_api\v6\apikey_header.html
	echo T_("Required parameters");                                                   // Line 3
	echo T_("on header");                                                             // Line 3
	echo T_("example");                                                               // Line 57
	...
	echo T_("cURL");                                                                  // Line 50
	echo T_("Response");                                                              // Line 57
	...
	//---------------docs\Projects\SalamQuran\content_api\v6\doc\150-hefz-program.html
	echo T_("Calculator hefz program");                                               // Line 13
	echo T_("Send your time and get result");                                         // Line 8

	//--------------------docs\Projects\SalamQuran\content_api\v6\doc\160-fav-add.html
	...
	//-------------------docs\Projects\SalamQuran\content_api\v6\doc\161-fav-edit.html
	echo T_("Update descriptio of favorites");                                        // Line 5
	echo T_("Character");                                                             // Line 57

	//-----------------docs\Projects\SalamQuran\content_api\v6\doc\162-fav-remove.html
	echo T_("Remove a saved favorites");                                              // Line 5

	//-------------------docs\Projects\SalamQuran\content_api\v6\doc\163-fav-list.html
	...
	echo T_("Please select one item");                                                // Line 48
	echo T_("Avatar");                                                                // Line 16
	echo T_("Read Type");                                                             // Line 25
	echo T_("filetype");                                                              // Line 35
	echo T_("Choose country");                                                        // Line 63
	echo T_("addr");                                                                  // Line 78
	echo T_("quality");                                                               // Line 87
	echo T_("Add");                                                                   // Line 95
	...
	//---------------------docs\Projects\SalamQuran\content_m\mag\connect\display.html
	echo T_("Select magazine");                                                       // Line 29
	echo T_("Connect to");                                                            // Line 80
	...
	echo T_("Select sura");                                                           // Line 164

	//------------------------docs\Projects\SalamQuran\content_m\mag\home\display.html
	...
	//------------------------------docs\Projects\SalamQuran\content_m\mag\layout.html
