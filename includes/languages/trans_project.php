...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Name");                                                                  // Line 144
	echo T_("Mobile");                                                                // Line 152
	...
	echo T_("Enter to your account and use SalamQuran account features");             // Line 18
