...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Maximum file size");                                                     // Line 337
	...
	echo T_("Recommended being more than 40 character and appear at the beginning of page content");// Line 379
	echo T_("Enter subtitle here");                                                   // Line 14
	echo T_("Subtitle show under title and used on press websites");                  // Line 12
	echo T_("Excerpt used for social media and search engines");                      // Line 412
	echo T_("If leave it empty we are generate it automatically");                    // Line 411
	...
	echo T_("Publish date");                                                          // Line 244
	echo T_("Default is now");                                                        // Line 246
	echo T_("Publish time");                                                          // Line 252
	echo T_("Add to gallery");                                                        // Line 330
	...
	echo T_("Without Parent");                                                        // Line 391
	...
	echo T_("Gallery");                                                               // Line 427
	echo T_("Click to download");                                                     // Line 66
	echo T_("Video");                                                                 // Line 440
	echo T_("MP3");                                                                   // Line 446
	echo T_("PDF");                                                                   // Line 99
	echo T_("Without preview");                                                       // Line 450
	...
	echo T_("Please enter valid mobile number. `:val` is incorrect");                 // Line 21
