...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Maximum file size");                                                     // Line 257
	...
	echo T_("All publish posts");                                                     // Line 151
	echo T_("Published");                                                             // Line 67
	echo T_("All draft posts");                                                       // Line 160
	echo T_("Draft");                                                                 // Line 76
	echo T_("All trash posts");                                                       // Line 169
	echo T_("Deleted");                                                               // Line 85

	//---------------------------------------addons\content_cms\attachment\layout.html
	echo T_("Enter title here");                                                      // Line 301
	echo T_("Recommended being more than 40 character and appear at the beginning of page content");// Line 299
	echo T_("Enter subtitle here");                                                   // Line 14
	echo T_("Subtitle show under title and used on press websites");                  // Line 12
	echo T_("Excerpt used for social media and search engines");                      // Line 331
	echo T_("If leave it empty we are generate it automatically");                    // Line 330
	...
	echo T_("Publish date");                                                          // Line 181
	echo T_("Default is now");                                                        // Line 183
	echo T_("Publish time");                                                          // Line 189
	echo T_("Add to gallery");                                                        // Line 250
	echo T_("Publish");                                                               // Line 206
	echo T_("Comment");                                                               // Line 131
	echo T_("You can publish in another language");                                   // Line 230
	echo T_("Language");                                                              // Line 277
	echo T_("Please select one item");                                                // Line 28
	echo T_("Choose parent for this page to create related url as tree");             // Line 307
	echo T_("Parent");                                                                // Line 307
	echo T_("Choose Parent");                                                         // Line 309
	echo T_("Without Parent");                                                        // Line 310
	echo T_("Choose category for posts is fix url of post relative and help people find it better.");// Line 89
	echo T_("Choose category of post");                                               // Line 155
	echo T_("Add new category");                                                      // Line 102
	echo T_("Click on special tags to use this depending on your website design");    // Line 132
	...
	echo T_("Gallery");                                                               // Line 346
	echo T_("Click to download");                                                     // Line 66
	echo T_("Video");                                                                 // Line 359
	echo T_("MP3");                                                                   // Line 365
	echo T_("PDF");                                                                   // Line 88
	echo T_("Without preview");                                                       // Line 369
