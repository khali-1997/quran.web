...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Get profile detail");                                                    // Line 59
	...
	echo T_("Get notification list");                                                 // Line 81
	...
	echo T_("Get android detail");                                                    // Line 83
	...
	echo T_("Terminate session");                                                     // Line 89
	...
	echo T_("API");                                                                   // Line 45
	echo T_("Introduction");                                                          // Line 47
	echo T_("Token");                                                                 // Line 8
	echo T_("Update profile");                                                        // Line 61
	echo T_("Upload avatar");                                                         // Line 63
	echo T_("Get about");                                                             // Line 71
	echo T_("Get mission");                                                           // Line 73
	echo T_("Get vision");                                                            // Line 75
	echo T_("Get contact");                                                           // Line 77
	echo T_("Check new notification");                                                // Line 79
	echo T_("Get app detail");                                                        // Line 85
	echo T_("Session list");                                                          // Line 87
	...
	echo T_("Maximum file size");                                                     // Line 222
	...
	echo T_("Enter title here");                                                      // Line 266
	echo T_("Recommended being more than 40 character and appear at the beginning of page content");// Line 264
	echo T_("Enter subtitle here");                                                   // Line 13
	echo T_("Subtitle show under title and used on press websites");                  // Line 13
	echo T_("Excerpt used for social media and search engines");                      // Line 293
	echo T_("If leave it empty we are generate it automatically");                    // Line 292
	...
	echo T_("Write post ");                                                           // Line 21
	echo T_("Allow change default publish date");                                     // Line 146
	echo T_("Publish date");                                                          // Line 147
	echo T_("Default is now");                                                        // Line 149
	echo T_("Publish time");                                                          // Line 155
	echo T_("Add to gallery");                                                        // Line 215
	echo T_("Publish");                                                               // Line 171
	echo T_("Comment");                                                               // Line 131
	echo T_("You can publish in another language");                                   // Line 195
	echo T_("Language");                                                              // Line 277
	echo T_("Please select one item");                                                // Line 28
	echo T_("Choose parent for this page to create related url as tree");             // Line 271
	echo T_("Parent");                                                                // Line 271
	echo T_("Choose Parent");                                                         // Line 273
	echo T_("Without Parent");                                                        // Line 274
	echo T_("Choose category for posts is fix url of post relative and help people find it better.");// Line 59
	echo T_("Choose category of post");                                               // Line 65
	echo T_("Add new category");                                                      // Line 75
	echo T_("Click on special tags to use this depending on your website design");    // Line 102
	...
	echo T_("Featured Image");                                                        // Line 40
	echo T_("allowed extentions jpg, png. Max 1000Kb");                               // Line 208
	echo T_("Gallery");                                                               // Line 308
	echo T_("Click to download");                                                     // Line 66
	echo T_("Video");                                                                 // Line 321
	echo T_("MP3");                                                                   // Line 327
	echo T_("PDF");                                                                   // Line 88
	echo T_("Without preview");                                                       // Line 331
	...
	echo T_("Comments");                                                              // Line 129
	echo T_("Help center");                                                           // Line 46
	...
	echo T_("Pages");                                                                 // Line 30
	echo T_("Help Center Article");                                                   // Line 162
	echo T_("Help tags");                                                             // Line 50
	echo T_("Support tags");                                                          // Line 54
	...
	echo T_("Magazine");                                                              // Line 18
	echo T_("Categories");                                                            // Line 62
	echo T_("Support");                                                               // Line 42
	echo T_("Files");                                                                 // Line 63
	echo T_("Library");                                                               // Line 67
	echo T_("Add new file");                                                          // Line 70
	...
	echo T_("Choose icon");                                                           // Line 49

	//--------------------------------------addons\content_cms\posts\home\display.html

	//--------------------------------------------addons\content_cms\posts\layout.html
	echo T_("Keywords");                                                              // Line 115
	echo T_("Add tag to link articles");                                              // Line 113
	echo T_("Allow Comments");                                                        // Line 134
	echo T_("Publish Date");                                                          // Line 144
	echo T_("Choose or Drop file here");                                              // Line 216
	echo T_("Google");                                                                // Line 253
	echo T_("Customize for SEO");                                                     // Line 258
	echo T_("SEO Title");                                                             // Line 264
	echo T_("End part of your post url.");                                            // Line 285
	echo T_("SEO Description");                                                       // Line 292
